  ...
  return (
    ...
    <div className="Imprint">
      ...
      <div className="first_sctn">
        <div className="lft">
          ...
          <p>
            ...
            unreasonable without concrete evidence of a violation of the law. If
            we become aware of any infringements, we will remove such links
            immediately..
          </p>
          <h3>Copyright</h3>
          <p>
            Content and works created by the site operators on these pages are
            subject to German copyright law. Duplication, editing, distribution
            and any kind of use outside the limits of copyright law requires the
            ...
            use. As far as the content on this site were not created by the
            operator, the copyrights of third parties are respected. In
            particular, the content of third parties are marked as such. Should
            you nevertheless become aware of a copyright infringement, please
            inform us accordingly. As soon as we become aware of any such
          ...
          <h3>1. Definitions</h3>
          <p>
            The data protection declaration of the Projector23 GmbH & Co. KG is
        ...
        <div className="rgt">
          ...
          <p>
            The contents of our pages have been prepared with the greatest care.
            ...
            violations of the law, we will remove these contents immediately.
          </p>
          ...
          <p>
            ...
            the management of the Projector23 GmbH & Co. KG. The use of the
            Internet pages of the Projector23 GmbH & Co. KG is possible without
          ...
          <p>
            ...
            applicable to the Projector23 GmbH & Co. KG. By means of this data
      ...
      <p>
        ...
        prosecution in case of a cyber-attack. Therefore, the Projector23 GmbH &
        Co. KG analyzes anonymously collected data and information
      ...
      <p>
        ...
        such processing; the existence of the right to lodge a complaint with a
        supervisory authority; where the personal data are not collected from
        the data subject, any available information as to their source; the
        ...
        subject. Furthermore, the data subject shall have a right to obtain
      ...
      <p>
        ...
        the GDPR, and where there is no other legal ground for the
        processing. The data subject objects to the processing pursuant to
        Article 21(1) of the GDPR and there are no overriding legitimate grounds
        ...
        unlawfully processed. The personal data must be erased for compliance
      ...
      <p>
        ...
        to request the erasure of personal data stored by the Projector23 GmbH &
        Co. KG, he or she may, at any time, contact any employee of the
        controller. An employee of Projector23 GmbH & Co. KG shall promptly
      ...
      <p>
        ...
        required. An employees of the Projector23 GmbH & Co. KG will arrange the
      ...
      <p>
        ...
        one of the following applies: The accuracy of the personal data is
        contested by the data subject, for a period enabling the controller to
        verify the accuracy of the personal data. The processing is unlawful and
        the data subject opposes the erasure of the personal data and requests
        instead the restriction of their use instead. The controller no longer
        ...
        of legal claims. The data subject has objected to processing pursuant to
      ...
      <p>
        ...
        contact any employee of the controller. The employee of the Projector23
        GmbH & Co. KG will arrange the restriction of the processing.
      </p>
      ...
      <p>
        ...
        the rights and freedoms of others. Furthermore, in exercising his or her
        right to data portability pursuant
      </p>
      <p>
        In order to assert the right to data portability, the data subject may
        at any time contact any employee of the Projector23 GmbH & Co. KG.
      </p>
      ...
      <p>
        The Projector23 GmbH & Co. KG shall no longer process the personal data
      ...
      <p>
        ...
        such direct marketing. If the data subject objects to the Projector23
        GmbH & Co. KG to the processing for direct marketing purposes, the
        Projector23 GmbH & Co. KG will no longer process the personal data for
        these purposes.
      </p>
      <p>
        ...
        concerning him or her by the Projector23 GmbH & Co. KG for scientific or
      ...
      <p>
        ...
        any employee of the Projector23 GmbH & Co. KG. In addition, the data
      ...
      <p>
        ...
        is based on the data subject’s explicit consent, the Projector23 GmbH &
        Co. KG shall implement suitable measures to safeguard the data subject’s
      ...
      <p>
        ...
        employee of the Projector23 GmbH & Co. KG.
      </p>
